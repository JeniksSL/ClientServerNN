...
public final class RawCharData {
     ...
     * received from getStandardData() method {@link ImageDataUtil}
     * class.
     *
     */
    ...
    /**
     * The static {@link LinkedList} that contains all instances of {@code RawCharData} class.
     *
     */
    private static final LinkedList<RawCharData> listOfClassInstances = new LinkedList<>();
